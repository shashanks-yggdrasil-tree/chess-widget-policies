...
Some features depend on third-party chess services and APIs, including Lichess.
Availability, performance, and data access may change at any time based on those providers.

## 3. Acceptable Use

You agree not to misuse the app, abuse API endpoints, bypass rate limits, scrape data in prohibited ways, or violate upstream service terms.
...
When using Lichess-powered features, you must comply with Lichess Terms of Service and API usage guidance.
The app may limit or disable requests to remain within rate-limit and abuse-prevention requirements.
...
To the fullest extent permitted by law, the app publisher is not liable for indirect, incidental, special, consequential, or punitive damages arising from use of the app.

## 8. Changes

These terms may be updated over time. Updated terms apply when published.
